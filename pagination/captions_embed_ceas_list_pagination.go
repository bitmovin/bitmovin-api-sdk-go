...
type CaptionsEmbedCeasListPagination struct {
	TotalCount *int64           `json:"totalCount,omitempty"`
	Offset     *int32           `json:"offset,omitempty"`
	Limit      *int32           `json:"limit,omitempty"`
	Previous   string           `json:"previous,omitempty"`
	Next       string           `json:"next,omitempty"`
	Items      []model.CaptionsEmbedCea `json:"items,omitempty"`
}


  func (o *CaptionsEmbedCeasListPagination) UnmarshalJSON(b []byte) error {
    var items []model.CaptionsEmbedCea
