...
func (m *DashProgressiveWebmRepresentationsListPagination) UnmarshalJSON(b []byte) error {
    var pageResp model.PaginationResponse
    if err := json.Unmarshal(b, &pageResp); err != nil {
        return err
    }

    var items []model.DashProgressiveWebmRepresentation
    if err := json.Unmarshal(pageResp.Items, &items); err != nil {
        return err
    }
    var result DashProgressiveWebmRepresentationsListPagination
