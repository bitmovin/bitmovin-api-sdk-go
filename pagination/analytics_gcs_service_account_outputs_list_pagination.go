...
func (m *AnalyticsGcsServiceAccountOutputsListPagination) UnmarshalJSON(b []byte) error {
	var pageResp model.PaginationResponse
	if err := json.Unmarshal(b, &pageResp); err != nil {
		return err
	}

	var items []model.AnalyticsGcsServiceAccountOutput
	if err := json.Unmarshal(pageResp.Items, &items); err != nil {
		return err
	}
	var result AnalyticsGcsServiceAccountOutputsListPagination
