...
func (m *NotificationStateEntrysListByNotificationIdPagination) UnmarshalJSON(b []byte) error {
    ...
    var result NotificationStateEntrysListByNotificationIdPagination
