...
func (m *SimpleEncodingVodJobResponsesListPagination) UnmarshalJSON(b []byte) error {
	var pageResp model.PaginationResponse
	if err := json.Unmarshal(b, &pageResp); err != nil {
		return err
	}

	var items []model.SimpleEncodingVodJobResponse
	if err := json.Unmarshal(pageResp.Items, &items); err != nil {
		return err
	}
	var result SimpleEncodingVodJobResponsesListPagination
