...
func (m *AkamaiAccountRegionSettingssListPagination) UnmarshalJSON(b []byte) error {
	var pageResp model.PaginationResponse
	if err := json.Unmarshal(b, &pageResp); err != nil {
		return err
	}

	var items []model.AkamaiAccountRegionSettings
	if err := json.Unmarshal(pageResp.Items, &items); err != nil {
		return err
	}
	var result AkamaiAccountRegionSettingssListPagination
