...
func (m *DolbyDigitalPlusAudioConfigurationsListPagination) UnmarshalJSON(b []byte) error {
	var pageResp model.PaginationResponse
	if err := json.Unmarshal(b, &pageResp); err != nil {
		return err
	}

	var items []model.DolbyDigitalPlusAudioConfiguration
	if err := json.Unmarshal(pageResp.Items, &items); err != nil {
		return err
	}
	var result DolbyDigitalPlusAudioConfigurationsListPagination
