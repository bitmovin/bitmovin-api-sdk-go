...
func (m *AnalyticsS3RoleBasedOutputsListPagination) UnmarshalJSON(b []byte) error {
	var pageResp model.PaginationResponse
	if err := json.Unmarshal(b, &pageResp); err != nil {
		return err
	}

	var items []model.AnalyticsS3RoleBasedOutput
	if err := json.Unmarshal(pageResp.Items, &items); err != nil {
		return err
	}
	var result AnalyticsS3RoleBasedOutputsListPagination
