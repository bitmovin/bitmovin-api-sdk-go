...
func (api *EncodingManifestsSmoothCustomdataApi) GetCustomData(manifestId string) (*model.CustomData, error) {
    var resp *model.CustomData
    reqParams := func(params *common.RequestParams) {
        params.PathParams["manifest_id"] = manifestId
	}
    err := api.apiClient.Get("/encoding/manifests/smooth/{manifest_id}/customData", &resp, reqParams)
    return resp, err
}
