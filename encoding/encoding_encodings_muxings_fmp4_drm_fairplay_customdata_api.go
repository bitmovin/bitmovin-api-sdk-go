...
func (api *EncodingEncodingsMuxingsFmp4DrmFairplayCustomdataApi) GetCustomData(encodingId string, muxingId string, drmId string) (*model.CustomData, error) {
    ...
    err := api.apiClient.Get("/encoding/encodings/{encoding_id}/muxings/fmp4/{muxing_id}/drm/fairplay/{drm_id}/customData", &resp, reqParams)
    return resp, err
}
