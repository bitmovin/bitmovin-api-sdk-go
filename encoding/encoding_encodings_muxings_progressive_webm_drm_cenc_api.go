...
func NewEncodingEncodingsMuxingsProgressiveWebmDrmCencApi(configs ...func(*common.ApiClient)) (*EncodingEncodingsMuxingsProgressiveWebmDrmCencApi, error) {
    ...
    api := &EncodingEncodingsMuxingsProgressiveWebmDrmCencApi{apiClient: apiClient}

    customdataApi, err := NewEncodingEncodingsMuxingsProgressiveWebmDrmCencCustomdataApi(configs...)
...
func (api *EncodingEncodingsMuxingsProgressiveWebmDrmCencApi) List(encodingId string, muxingId string, queryParams ...func(*query.CencDrmListQueryParams)) (*pagination.CencDrmsListPagination, error) {
