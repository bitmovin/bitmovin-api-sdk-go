...
func NewEncodingEncodingsMuxingsProgressiveTsDrmAesApi(configs ...func(*common.ApiClient)) (*EncodingEncodingsMuxingsProgressiveTsDrmAesApi, error) {
    ...
    api := &EncodingEncodingsMuxingsProgressiveTsDrmAesApi{apiClient: apiClient}

    customdataApi, err := NewEncodingEncodingsMuxingsProgressiveTsDrmAesCustomdataApi(configs...)
...
func (api *EncodingEncodingsMuxingsProgressiveTsDrmAesApi) List(encodingId string, muxingId string, queryParams ...func(*query.AesEncryptionDrmListQueryParams)) (*pagination.AesEncryptionDrmsListPagination, error) {
