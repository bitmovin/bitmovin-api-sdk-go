...
func (api *EncodingEncodingsMuxingsProgressiveTsId3FrameIdCustomdataApi) GetCustomData(encodingId string, muxingId string, id3TagId string) (*model.CustomData, error) {
    ...
    err := api.apiClient.Get("/encoding/encodings/{encoding_id}/muxings/progressive-ts/{muxing_id}/id3/frame-id/{id3_tag_id}/customData", &resp, reqParams)
    return resp, err
}
