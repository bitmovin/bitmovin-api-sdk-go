...
func (api *EncodingEncodingsMuxingsWebmDrmCencCustomdataApi) GetCustomData(encodingId string, muxingId string, drmId string) (*model.CustomData, error) {
    ...
    err := api.apiClient.Get("/encoding/encodings/{encoding_id}/muxings/webm/{muxing_id}/drm/cenc/{drm_id}/customData", &resp, reqParams)
    return resp, err
}
